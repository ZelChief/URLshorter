...
return array(
    ...
    'index_welcome' => 'Добро пожаловать. Для того чтобы воспользоваться сервисом сокращения ссылок необходимо быть зарегистрированным пользователем.',
    'tables' => array (
        'domen1' => 'bmstu.net',
        'domen2' => 'bmstu.wiki',
        'domen3' => 'bmstu.online',
        ...
        'others' => 'Другие',
        'cols'   => array (
            'col1' => 'URL от пользователя',
            'col2' => 'Короткий URL',
            'col3' => 'Время создания ссылки',
            'col4' => 'Количество переходов',
            'col5' => 'Редактирование',
        ),
        'button' => 'Сохранить',
    ),
    ...
    'admin'          => array(
        ...
        'items'                => array(
            ...
            'tables' => '___admin.tables.title___',
            'invite' => '___admin.invite.title___',
        ),
        'install_plugin_admin' => 'Установить расширенную админ-панель',
        // Страница администрирования плагинов
        'tables'               => array(
            'title'   => 'Отсортированные списки ссылок'
            ),
        'invite'               => array(
            'title'   => 'Приглашения'
            ),
